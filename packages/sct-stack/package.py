...
class SctStack(BundlePackage, Key4hepPackage):
    ...
    LCG_external_package("redis             5.0.9                                   ")
    ...
    LCG_external_package("py-4suite-xml            1.0.2                                  ")
    ...
    # LCG_external_package("couchdb           1.2                                      ") # can only be done in python2 because of mozjs
    LCG_external_package("py-coverage          4.5.1                                    ")
    LCG_external_package("cppgsl            2.1.0                                    ")
    ...
    LCG_external_package("gettext           0.21                                 ")
    ...
    LCG_external_package("openjdk              1.8:                                     ")
    ...
    LCG_external_package("lcov              1.15                                      ")
    LCG_external_package("libaio            0.3.110                                ")
    LCG_external_package("libdrm            2.4.100                                  ")
    LCG_external_package("libepoxy          1.5.4                                    ")
    LCG_external_package("libffi            3.2.1                                    ")
    LCG_external_package("libgit2           0.27.0                                   ")
    LCG_external_package("libsvm            323                                     ")
    ...
    LCG_external_package("libpng               1.6.37                                   ")
    ...
    LCG_external_package("uuid              1.4.2                                     ")
    ...
    LCG_external_package("yaml-cpp           0.6.3                                    ")
